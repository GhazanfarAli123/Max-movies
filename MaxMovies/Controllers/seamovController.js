...
export const  getSeaMovByCat = async(req,res) =>{
  ...
  try{
    ...
    const data = await seamovmodal.find({category : id})
...
export const  getSeaMovByGer = async(req,res) =>{
  
  try{
    const id = req.params.id;

    const data = await seamovmodal.find({gerneses : id})
...
export const  getSeaMovByCountry = async(req,res) =>{
  
  try{
    const id = req.params.id;

    const data = await seamovmodal.find({countries : id})
